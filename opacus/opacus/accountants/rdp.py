...
class RDPAccountant(IAccountant):
    ...
    # DEFAULT_ALPHAS = [1 + x / 10.0 for x in range(1, 100)] + list(range(12, 64)) + list(range(64, 4096, 64))
    logger.info(f"Using alphas: {DEFAULT_ALPHAS}")
    ...
    def get_privacy_spent(
        ...
        # print(f"RDP Accountant: best alpha for {eps} is {best_alpha}")
    ...
    def get_epsilon(
        ...
        # print(f"RDP Accountant: epsilon for {delta} is {eps}")
        return eps
